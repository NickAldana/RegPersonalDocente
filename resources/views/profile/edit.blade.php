                    ...
                    <div class="card-body p-0">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4 bg-gray-50 border-end border-light p-5 text-center d-flex flex-column align-items-center">
                                ...
                                <h5 class="fw-black text-upds-blue mb-1">{{ explode(' ', $docente->NombreCompleto)[0] }} {{ $docente->ApellidoPaterno }}</h5>
                                <p class="text-muted small fw-bold text-uppercase tracking-wider mb-3">
                                    {{ $docente->cargo->NombreCargo ?? 'Usuario' }}
                                </p>

                                <div class="badge bg-white text-dark border px-3 py-2 rounded-pill shadow-sm mb-4">
                                    <i class="bi bi-circle-fill text-success me-2" style="font-size: 8px;"></i> Cuenta Activa
                                </div>

                                <p class="small text-muted fst-italic px-3">
                                    "La fotografía se utilizará para su credencial digital y documentos oficiales."
                                </p>
                            </div>
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="row g-4">
                                        <div class="col-12">
                                            ...
                                            <input type="text" class="form-control sia-input bg-gray-50 text-dark fw-bold" value="{{ $docente->NombreCompleto }} {{ $docente->ApellidoPaterno }} {{ $docente->ApellidoMaterno }}" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label sia-label">Documento de Identidad</label>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control sia-input bg-gray-50 text-dark" value="{{ $docente->contrato->NombreContrato ?? 'No Definido' }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row g-4">
                                        <div class="col-md-7">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="CorreoElectronico" class="form-control sia-input border-start-0 ps-2" value="{{ old('CorreoElectronico', $docente->CorreoElectronico) }}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="Telefono" class="form-control sia-input border-start-0 ps-2" value="{{ old('Telefono', $docente->Telefono) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer bg-white p-4 border-top">
                        <div class="d-flex justify-content-end align-items-center gap-3">
                            <span class="text-muted small fst-italic me-auto d-none d-md-inline">
                                <i class="bi bi-info-circle me-1"></i> Los campos con fondo gris no son editables.
                            </span>
